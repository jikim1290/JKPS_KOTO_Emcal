...
%The resolution of the reconstruction is defined as the standard deviation of Gaussian function around $\pm$~2 times standard deviations from the peak of the distribution.
